...
class PHPExcel_Style_NumberFormat implements PHPExcel_IComparable
{
	...
	const FORMAT_DATE_DDMMYYYYDOT			= 'dd.mm.yy';
	...
	const FORMAT_CURRENCY_BGN_SIMPLE		= '#,##0.00_- [$ыт.]';
	...
	{	
		if ($pValue==PHPExcel_Style_NumberFormat::FORMAT_CURRENCY_BGN_SIMPLE) {
			$pValue = iconv("Windows-1251", "UTF-8", PHPExcel_Style_NumberFormat::FORMAT_CURRENCY_BGN_SIMPLE);
		}
		if ($pValue == '') {
